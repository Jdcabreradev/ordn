  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ItemViewmodel>(
      builder: (context, itemViewmodel, child) {
        final updatedItem = itemViewmodel.items.firstWhere(
          (i) => i.id == item.id,
          orElse: () => item,
        );
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                "Prioridad: ${updatedItem.priority.name}",
                                style: const TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.bold,
                                ),
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () async {
                          await context.push('/form', extra: updatedItem);
                        },
                        icon: const Icon(
                          Icons.edit,
                          color: Colors.white,
                    ...
                    Expanded(
                      child: ElevatedButton.icon(
                        onPressed: () {
                          _showDeleteConfirmation(context, updatedItem);
                        },
                        icon: const Icon(
                          Icons.delete,
                          color: Colors.white,
